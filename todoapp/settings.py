...
import datetime  # Add this import for JWT configuration
...
INSTALLED_APPS = [
    ...
    'rest_framework_jwt',  # Add JWT Authentication to installed apps
    'core',  # Replace 'myapp' with your app's name
]
